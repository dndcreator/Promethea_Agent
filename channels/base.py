"""Shared channel contracts and lifecycle helpers."""
...
class ChannelType(str, Enum):
    """Supported inbound and outbound channel families."""
    WEB = "web"
    DINGTALK = "dingtalk"
    FEISHU = "feishu"
    WECOM = "wecom"
...
class MessageType(str, Enum):
    """Normalized payload kinds handled by channel adapters."""
    TEXT = "text"
    MARKDOWN = "markdown"
    CARD = "card"
    IMAGE = "image"
...
class Message(BaseModel):
    """Canonical message envelope passed from channels into the runtime."""
    message_id: str
    channel: ChannelType
...
class ChannelConfig(BaseModel):
    """Connection settings shared by first-party channel adapters."""
...
class BaseChannel(ABC):
    """Abstract async adapter for a chat, API, webhook, or enterprise channel."""
    ...
    async def connect(self) -> bool:
        """Open provider resources and mark the channel as connectable."""
        pass
    ...
    async def send_message(
        ...
        **kwargs
        ...
        """Send a normalized message payload to a provider-specific receiver."""
        pass
    ...
    async def send_card(
        ...
        **kwargs
        ...
        """Send a rich card payload when the channel supports it."""
        pass

    @abstractmethod
    async def get_user_info(self, user_id: str) -> Optional[Dict[str, Any]]:
        """Return provider user metadata when available."""
        pass

    async def start(self) -> bool:
        """Start the channel if enabled and connected successfully."""
        if self.is_running:
    ...
    async def stop(self) -> bool:
        """Stop the channel and clear connection state."""
    ...
    def on_message(self, callback: Callable):
        """Register a callback for inbound normalized messages."""
        if callback not in self._on_message_callbacks:
            self._on_message_callbacks.append(callback)

    def on_event(self, callback: Callable):
        """Register a callback for provider events that are not chat messages."""
    ...
    async def _emit_message(self, message: Message):
        """Dispatch an inbound message to registered callbacks."""
    ...
    async def _emit_event(self, event_type: str, event_data: Dict[str, Any]):
        """Dispatch a provider event to registered callbacks."""
    ...
    def get_status(self) -> Dict[str, Any]:
        """Return a lightweight channel health snapshot."""
        return {
    ...
    async def validate_config(self) -> bool:
        """Validate minimum channel configuration before startup."""
        if not self.config.enabled:
            return True
        return True

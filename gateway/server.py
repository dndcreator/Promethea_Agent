...
class GatewayServer:
    ...
    async def _handle_chat(self, connection: Connection, request: RequestMessage) -> ResponseMessage:
        ...
        from .chat_gateway_handler import handle_chat

        return await handle_chat(self, connection, request)
    ...
    async def _handle_chat_confirm(self, connection: Connection, request: RequestMessage) -> ResponseMessage:
        ...
        from .chat_gateway_handler import handle_chat_confirm

        return await handle_chat_confirm(self, connection, request)
